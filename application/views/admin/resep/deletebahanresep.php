	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
      		<div class="modal-header">
        		<h4 class="modal-title " id="modalLabel">HAPUS DATA BAHAN</h4>
      	...
      	<div class="modal-footer">
        	...
        	<a href="<?php echo base_url('admin/resep/deletebahanresep/'.$bahan->id) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Ya, Hapus Data Ini</a>
      	</div>
    	</div>
  </div>
</div>