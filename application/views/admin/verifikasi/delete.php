...
<button type="button" class="btn btn-danger btn-xs col-12 mt-1" data-toggle="modal" data-target="#delete-<?php echo $resep->id ?>">
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
      	...
      	<div class="modal-footer">
        	...
        	<a href="<?php echo base_url('admin/verifikasi/delete/'.$resep->id) ?>" class="btn btn-danger"><i class="fa fa-trash"></i> Ya, Hapus Data Ini</a>
      	</div>
    	</div>
  </div>
</div>